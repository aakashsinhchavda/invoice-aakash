...
const InvoiceForm = ({ onPreviewUpdate, onDownload, isDownloading }) => {
    ...
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-full overflow-y-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <button 
          ...
          className={`inline-flex items-center px-4 py-2 bg-black text-white rounded-lg transition-colors text-sm font-bold shadow-md ${isDownloading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-gray-800'}`}
        >
          {isDownloading ? (
            <>
